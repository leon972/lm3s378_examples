...
;******************************************************************************
;
; Dichiara come EXTERN le ISR utilizzate dall'applicazione per la gestione
; degli interrupt 
; (questa ISR è anche mappata nel vettore degli interrupt (vedi più avanti)
;
;******************************************************************************
...
__Vectors
		...
		;Interrupt s.r. per la gestione dei click del tasto di selezione
        DCD     ISRButtonClick              ; GPIO Port B
		...
		;Mappa le Interrupt Service Routines utilizzata da questa applicazione
		;per la gestione dei timers

        DCD     ISRTimer0A                  ; Timer 0A
        DCD     ISRTimer0B           ; Timer 0B
        DCD     ISRTimer1A           ; Timer 1A
        DCD     ISRTimer1B           ; Timer 1B
        DCD     ISRTimer2A           ; Timer 2A
        DCD     ISRTimer2B           ; Timer 2B
        ...
        DCD     ISRTimer3A           ; Timer 3 subtimer A
        DCD     ISRTimer3B           ; Timer 3 subtimer B
